...
export const selectSupportedCurrencyPairs = (
  state: RootState
): SupportedCurrencyPairs[] | null => state.supportedCurrencyPairs.data;
export const selectIsLoading = (state: RootState): boolean =>
  state.supportedCurrencyPairs.isLoading;
export const selectErrors = (state: RootState): Error | null =>
  state.supportedCurrencyPairs.errors;
